      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#C25934]/15 pb-8">
          ...
          <div className="flex flex-col items-start md:items-end gap-2 shrink-0">
            <span className="text-[11px] text-textPrimary/60 font-mono uppercase tracking-wider">Test Payment Gateway</span>
            <PaymentButton amount={500} recipientName="Local Artisan" />
          </div>
        </div>
